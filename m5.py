...
async def main():
    ...
    drive_base.settings(straight_speed=1000, straight_acceleration=1000, turn_rate=1000, turn_acceleration=1000)
    await tank_turn(hub, leftdrive_motor, rightdrive_motor, -120, 1000)
